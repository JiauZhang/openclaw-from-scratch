...
→ 详细讲解参见 [第 3 章 Agent 核心抽象](ch03-agent-core/README.md)
...
→ 详细讲解参见 [第 4 章 Agent 核心循环](ch04-agent-loop/README.md)
...
→ 详细讲解参见 [第 5 章 工具系统](ch05-tool-system/README.md)
...
→ 详细讲解参见 [第 5 章 工具系统](ch05-tool-system/README.md) §5.3 工具规划器
...
→ 详细讲解参见 [第 6 章 LLM 集成](ch06-llm-integration/README.md) §6.2 LLM 类型系统
...
→ 详细讲解参见 [第 4 章 Agent 核心循环](ch04-agent-loop/README.md) §4.5 事件流系统
...
→ 详细讲解参见 [第 7 章 网关与消息分发](ch07-gateway-messaging/README.md)
...
→ 详细讲解参见 [第 8 章 插件 SDK](ch08-plugin-sdk/README.md)
...
→ 详细讲解参见 [第 7 章 网关与消息分发](ch07-gateway-messaging/README.md) §7.6 渠道集成
...
→ 详细讲解参见 [第 9 章 沙箱与安全](ch09-sandbox-security/README.md)